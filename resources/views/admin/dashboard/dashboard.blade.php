                                ...
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
                                        ...
                                        <span class="kt-widget17__subtitle">
                                         Total Receptions Department
                                        </span>
                                        <span class="kt-widget17__desc">
                                            {{$data_total->data_total_Receptions}} total users
                                        </span>
                                    </div>
                                    <div class="kt-widget17__item">
                                        <span class="kt-widget17__icon">
                                        ...
                                        <span class="kt-widget17__desc">
                                        {{$data_total->data_total_Projects}} total users
                                        </span>
                                    </div>
                                </div>
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
                                        ...
                                        <span class="kt-widget17__subtitle">
                                            Total Marketing Department
                                        </span>
                                        <span class="kt-widget17__desc">
                                        {{$data_total->data_total_Marketing}} total users
                                        </span>
                                    </div>
                                    <div class="kt-widget17__item">
                                        <span class="kt-widget17__icon">
                                        ...
                                        <span class="kt-widget17__subtitle">
                                            Total Account Department
                                        </span>
                                        <span class="kt-widget17__desc">
                                        {{$data_total->data_total_Account}} total users
                                        </span>
                                    </div>
                                </div>
                            </div>
