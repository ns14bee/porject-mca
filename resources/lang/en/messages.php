...
return [
    /* Admin Section Start */
        'siteName' => 'Apurva Water Solution',
        'footerEmailTeam' => 'Apurva Water Solution Team',
        'footer' => 'Apurva Water Solution | All rights reserved',
        'success'=>"Success !!",
        'error'=>"Error !!",
        'update'=>"Updated !!",
        ...
        /*  User Module */
        'userCreations'=>"Employee created successfully",
        ...
        'blogUpdate'=>'Blog updated successfully',
        ...
        /* Leave Module */
        'LeaveCreated'=>'Leave Add successfully',

        /*  File Module */
        'fileuploadingCreated' => 'File created successfully',    
        
        /*  Department Module */
        'departmentCreated'=>'Department created successfully',
        'departmentUpdate'=>'Department updated successfully',
        'attchmenetDelete'=>'Attachment deleted successfully',
        'nofoundDepartment'=>'No Attachments found!',
        'noDepartmentHistory'=>'No Department History found!',
